...
%TODO 2 To proszę napisać takie zdanie, że w opisanej wersji systemu CPU nie realizowało...
...
%TODO 2 coś w tym zdaniu nie jest OK...
...
%TODO 2 Coś to zdanie jest zbyt zamotoane... Może Niniejsze praca magisterska jest....
...
Poprzednio \textit{muliscale} osiągnięto dzięki zastosowaniu kilku wzorców. %TODO 2 może uniknąć tego muliscale jakoś.. połączyć z poprzednim zdaniem ...
Pojedynczy wzorzec zapewniał detekcję w~pewnym zakresie wysokości przechodniów. 
Im dalej odbiegał od swojej nominalnej wysokości, tym bardziej należało zmniejszyć parametr $K$, by w pojedynczym oknie było możliwe wykrycie mniejszych i~większych sylwetek. %TODO 2 K to próg ? może to napisać w nawiasie/
