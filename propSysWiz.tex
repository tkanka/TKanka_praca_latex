...
\item \textit{End Of Line} (\textit{tlast})-- linia sygnalizacyjna ostatniego piksela w linii. %TODO OK tu i wyżej "wskazuje" to złe słowo.
...
Bloki nakładają się na siebie więc w pojedynczym oknie można wyodrębnić 44 bloki. %TODO ok Styl.
...
Następnie został obliczony przykładowy błąd względny między wektorem cech wyliczonym w pakiecie Matlab a uzyskanym z systemu wizyjnego. %TODO OK jak programowej, to tu bym się spodziewał czegoś a'la sprzętowej
...
Dzięki zastosowaniu sprzętowego wyszukiwania ROI zadanie systemu procesorowego zostało ograniczone do analizy pojedynczego ROI. %TODO OK styl. to zawierania w sobie, poza tym - dalczego akurat tylko jednego.
